...
transition: Slide,
  ...
  Send Message
      ...
      ): <button className="w-full relative flex  justify-center font-semibold text-xl items-center gap-2 bg-red-600 hover:bg-red-800 text-white px-3 py-2.5 rounded transition-all" onClick={handleClose}>
